...
public class Erratique extends Neuneu {
	 ...
	 * Constructeur
	 */
	public Erratique(int id, int energie, int energieDefaut, boolean presenceLoft, CaseLoft coord) {
	...
	public void seReproduire(Neuneu N) {
		...
		Erratique babyErratique = new Erratique(idBaby, energieBaby, energieDefautBaby, presenceLoftBaby, coordBaby) ;
